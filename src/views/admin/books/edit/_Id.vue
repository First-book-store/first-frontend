<template>
    <div class="flex justify-center">
      <form class="flex flex-wrap justify-between w-3/4 p-6 mt-8 shadow-md" @submit.prevent="editBook">
  ...
  export default {
      ...
      mounted () {
        ...
        ApiService.get('admin/tags').then((res) => {
      ...
      methods : {
        editBook () {
          ...
          ApiService.patch(`admin/books/${this.slug}` , this.formData).then((res) => {
